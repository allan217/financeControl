...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Agosto")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Agosto", JSON.stringify(transactions))
}
}
