...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Abril")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Abril", JSON.stringify(transactions))
}
}
