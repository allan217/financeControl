...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Dezembro")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Dezembro", JSON.stringify(transactions))
}
}
