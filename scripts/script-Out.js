...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Outubro")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Outubro", JSON.stringify(transactions))
}
}
