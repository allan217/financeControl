...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Junho")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Junho", JSON.stringify(transactions))
}
}
