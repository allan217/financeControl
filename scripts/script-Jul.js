...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Julho")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Julho", JSON.stringify(transactions))
}
}
