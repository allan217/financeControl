...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Novembro")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Novembro", JSON.stringify(transactions))
}
}
