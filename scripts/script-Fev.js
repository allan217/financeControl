...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Fevereiro")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Fevereiro", JSON.stringify(transactions))
}
}
