...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Maio")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Maio", JSON.stringify(transactions))
}
}
