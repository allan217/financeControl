...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Março")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Março", JSON.stringify(transactions))
}
}
