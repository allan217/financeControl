...
const Storage = {
get() {
	return JSON.parse(localStorage.getItem("control.finances:transaction-Janeiro")) || []
},
set(transactions) {
	localStorage.setItem("control.finances:transaction-Janeiro", JSON.stringify(transactions))
}
}
